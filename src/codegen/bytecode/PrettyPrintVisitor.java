...
public class PrettyPrintVisitor implements Visitor {
	...
	@Override
	public void visit(codegen.bytecode.stm.Ifeq s) {
	...
	public void visit(codegen.bytecode.stm.Putfield s) {
		this.say("    putfield " + s.classId + "/" + s.id + " ");
		s.type.accept(this);
		this.sayln("");
		return;
	}
	...
	public void visit(codegen.bytecode.stm.Getfield s) {
		this.say("    getfield " + s.classId + "/" + s.id + " ");
		s.type.accept(this);
		this.sayln("");
		return;
	}
	...
	public void visit(codegen.bytecode.classs.Class c) {
		...
		try {
			this.writer = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(c.id + ".j")));
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(1);
		}

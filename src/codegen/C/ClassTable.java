...
public class ClassTable {
	...
	public void initDecs(String current, java.util.LinkedList<codegen.C.dec.T> decs) {
	...
	public void initMethod(String current, codegen.C.type.T ret, java.util.LinkedList<codegen.C.dec.T> args, String mid) {
		ClassBinding cb = this.table.get(current);

...
public class TranslateVisitor implements ast.Visitor {
	...
	public void visit(ast.exp.Add e) {
		e.left.accept(this);
		codegen.C.exp.T t = this.exp;
		e.right.accept(this);
		this.exp = new codegen.C.exp.Add(t, this.exp);
	}
	...
	public void visit(ast.exp.And e) {
		...
		codegen.C.exp.T t = this.exp;
		e.right.accept(this);
		this.exp = new codegen.C.exp.And(t, this.exp);
	}
	...
	public void visit(ast.exp.ArraySelect e) {
		...
		codegen.C.exp.T t = this.exp;
		e.index.accept(this);
		this.exp = new codegen.C.exp.ArraySelect(t, this.exp);
	}
	...
	public void visit(ast.exp.Call e) {
		...
		this.exp = new codegen.C.exp.Call(newid, exp, e.type + "_" + e.id, args, retType);
		return;
	}
	...
	public void visit(ast.stm.Block s) {
		...
		java.util.LinkedList<codegen.C.stm.T> list = new java.util.LinkedList<codegen.C.stm.T>();
		for (ast.stm.T stm : s.stms) {
			stm.accept(this);
			list.add(this.stm);
		}
		this.stm = new codegen.C.stm.Block(list);
	}
	...
	public void visit(ast.type.Id t) {
		this.type = new codegen.C.type.Id(t.id);
	}
	...
	public void visit(ast.method.Method m) {
		...
		this.method = new codegen.C.method.Method(newRetType, this.classId, m.id, newFormals, locals, newStm, retExp);
		return;
	}
	...
	private void addMethod(ast.classs.Class c) {
		for (ast.method.T m : c.methods) {
			m.accept(this);
			codegen.C.method.Method method0 = ((codegen.C.method.Method) this.method);
			for (codegen.C.method.T t : this.methods) {
				codegen.C.method.Method method = (codegen.C.method.Method) t;

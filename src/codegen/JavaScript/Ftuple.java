...
public class Ftuple
{
  ...
  public codegen.JavaScript.type.T ret; // type of the field
  public java.util.LinkedList<codegen.JavaScript.dec.T> args; // type of args
  public String id; // name of the field or method

  public Ftuple(String classs, codegen.JavaScript.type.T ret,
      java.util.LinkedList<codegen.JavaScript.dec.T> args, String id)
  {
    this.classs = classs;
    this.ret = ret;
    this.args = args;

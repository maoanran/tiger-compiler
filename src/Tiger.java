...
// codegen.bytecode.TranslateVisitor trans = new
// codegen.bytecode.TranslateVisitor();
// ast.Fac.prog.accept(trans);
// codegen.bytecode.program.T bytecodeAst = trans.program;
// codegen.bytecode.PrettyPrintVisitor ppbc = new
// codegen.bytecode.PrettyPrintVisitor();
...
// codegen.JavaScript.TranslateVisitor transJavaScript = new
// codegen.JavaScript.TranslateVisitor();
// ast.Fac.prog.accept(transJavaScript);
// codegen.JavaScript.program.T JavaScriptAst = transJavaScript.program;
// codegen.JavaScript.PrettyPrintVisitor ppJavaScript = new
// codegen.JavaScript.PrettyPrintVisitor();
...
// codegen.bytecode.program.Program pro = (codegen.bytecode.program.Program)
// trans.program;
...
// }
//
// Process p = Runtime.getRuntime().exec(winCmd + "java -jar jasmin.jar " +
// mainId + ".j");
// p.waitFor();
...
// p = Runtime.getRuntime().exec(winCmd + "java -jar jasmin.jar " + cla.id +
// ".j");
// p.waitFor();
...
// String osName = System.getProperty("os.name");
// if (osName.toLowerCase().indexOf("windows") > -1) {
// Process p = Runtime.getRuntime().exec("cmd /c gcc " + fname + ".c" +
// " runtime\\runtime.c  -o " + fname + ".exe");
...
// } else {
// Process p = Runtime.getRuntime().exec("gcc " + fname + ".c" +
// " runtime/runtime.c  -o " + fname + ".out");

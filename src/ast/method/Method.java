...
public class Method extends T {
	...
	public Method(ast.type.T retType, String id, java.util.LinkedList<ast.dec.T> formals, java.util.LinkedList<ast.dec.T> locals,
	...
	public Method(ast.type.T retType, String id, java.util.LinkedList<ast.dec.T> formals, java.util.LinkedList<ast.dec.T> locals,
			java.util.LinkedList<ast.stm.T> stms, ast.exp.T retExp, int lineNum) {
		this.retType = retType;
		this.id = id;
		this.formals = formals;
		this.locals = locals;

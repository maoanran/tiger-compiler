...
public class ConstFold implements ast.Visitor {
	...
	public void visit(ast.exp.Add e) {
		...
		if (left.toString().startsWith("ast.exp.Num@") && right.toString().startsWith("ast.exp.Num@")) {
			int leftt = ((ast.exp.Num) left).num;
			int rightt = ((ast.exp.Num) right).num;
			this.expp = new ast.exp.Num(leftt + rightt);
	...
	public void visit(ast.exp.Lt e) {
		...
		if (left.toString().startsWith("ast.exp.Num@") && right.toString().startsWith("ast.exp.Num@")) {
			int leftt = ((ast.exp.Num) left).num;
			int rightt = ((ast.exp.Num) right).num;
			this.expp = leftt < rightt ? new ast.exp.True() : new ast.exp.False();
			ast.optimizations.Main.modified();

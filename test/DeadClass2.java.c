...
struct Junk_vtable Junk_vtable_ ;
...
int Fac_yes(struct Fac * this)
{

	char * Fac_yes_arguments_gc_map = "1";
	char * Fac_yes_locals_gc_map = "";
	//put the GC stack frame onto the call stack.
	struct Fac_yes_gc_frame frame;
	//push this frame onto the GC stack by setting up "prev".
	frame.frame_prev = frame_prev;
	frame_prev = &frame;
	//setting up memory GC maps and corresponding base addresses
	frame.arguments_gc_map = Fac_yes_arguments_gc_map;
	frame.arguments_base_address = (int *)&this;
	frame.locals_gc_map = Fac_yes_locals_gc_map;
